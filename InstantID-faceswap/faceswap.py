...
if __name__ == '__main__':
    ...
    pose_image = load_image(target_image_path)
    pose_image_name = target_image_path.split('/')[-1].split('.')[0] + '_0.png'
    output_path = os.path.join('examples/hf_test/output', pose_image_name)
